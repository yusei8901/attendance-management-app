                ...
                <table>
                    ...
                    @forelse($pendingAttends as $pendingAttend)
                        <tr>
                            ...
                            <td><a href="{{ route('user.attendance.detail', $pendingAttend->attendance_id) }}" class="detail-link">詳細</a></td>
                        </tr>
                    @empty
                ...
                <table>
                    ...
                    @forelse($approvedAttends as $approvedAttend)
                        <tr>
                            ...
                            <td><a href="{{ route('user.attendance.detail', $approvedAttend->attendance_id) }}" class="detail-link">詳細</a></td>
                        </tr>
                    @empty
