        ...
        <div class="content-wrapper">
            ...
            <div class="attendance-month">
                <a class="month-before"
                    href="{{ route('admin.staff.attendance', ['id' => $user->id,'year' => $current->copy()->subMonth()->year, 'month' => $current->copy()->subMonth()->month]) }}">
                    前月
                </a>
                ...
                <a class="month-next"
                    href="{{ route('admin.staff.attendance', ['id' => $user->id, 'year' => $current->copy()->addMonth()->year, 'month' => $current->copy()->addMonth()->month]) }}">
                    翌月
                </a>
            </div>
                ...
                <table>
                    ...
                    @foreach ($days as $day)
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($attend)
                                    <a class="detail-link" href="{{ route('admin.attendance.detail', $attend->id) }}">
                                        詳細
                                    </a>
                                @else
                                    ー
