                ...
                <form class="detail-form" action="{{ route('admin.attendance.edit', ['id' => $attend->id]) }}" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($attend->status === 'before_request')
                                        <input type="text" name="start_time" value="{{ old('start_time', formatTimeNullable($attend->start_time)) }}">
                                    @else
                                ...
                                <td>
                                    @if ($attend->status === 'before_request')
                                        <input type="text" name="end_time" value="{{ old('end_time', formatTimeNullable($attend->end_time)) }}">
                                    @else
                    ...
                    <div class="button-wrapper">
                        @if ($attend->status === 'pending')
                            <p class="info-text">*打刻修正申請が届いています。</p>
                        @elseif($attend->status === 'approved')
                            <p class="info-text">*打刻申請認証済みのため修正できません。</p>
                        @else
